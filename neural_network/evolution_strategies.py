...
class Solution:
    ...
    def evaluate_model(self, x_transformed: np.ndarray, partial_contribution_objective: bool, num_components: int) -> [float]:

        objective_value = compute_fitness(x_transformed, partial_contribution_objective, num_components)
