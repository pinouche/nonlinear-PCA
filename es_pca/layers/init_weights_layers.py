from es_pca.layers.layers import ForwardLayer


def create_nn_for_numerical_col(n_features, n_layers, hidden_size, activation="leaky_relu", init_mode="identity"):
    layers_list = list()

    layers_list.append(ForwardLayer(n_features, hidden_size, activation, init_mode="identity"))
    ...
    layers_list.append(ForwardLayer(hidden_size, 1, 'identity', init_mode="identity"))
